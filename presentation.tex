...
\author[Team Name]{Team Name: [Insert Team Name]}
\institute[Hackathon]{[Insert Hackathon Name]}
\date{\today}
...
\begin{frame}{Team Member Details}
    \begin{table}
        ...
        [Name 1] & [Email] & Lead Dev / UI & [District] & [M/F/O] \\ \hline
        [Name 2] & [Email] & Backend Eng. & [District] & [M/F/O] \\ \hline
        [Name 3] & [Email] & Risk Logic & [District] & [M/F/O] \\ \hline
        [Name 4] & [Email] & UI/UX Design & [District] & [M/F/O] \\ \hline
        \end{tabular}
    \end{table}
\end{frame}
...
\begin{frame}{Technology Stack \& Scope}
    \begin{columns}
        ...
        \textbf{Scope}
        \begin{itemize}
            \item \textcolor{green!50!black}{\checkmark In:} Risk eval, Active call detection, Dynamic UI.
            \item \textcolor{red}{\ding{55} Out:} Biometrics, Full core banking logic.
        \end{itemize}
    \end{columns}
\end{frame}

% --- Slide 9: UI/UX Prototypes (Part 1) ---
\begin{frame}{UI/UX Prototypes (Dashboard)}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
...
% --- Slide 10: UI/UX Prototypes (Part 2) ---
\begin{frame}{UI/UX Prototypes (Scenarios)}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \textbf{Low Risk Scenario}\\
        \includegraphics[width=0.95\textwidth]{3.jpeg}
        
        \column{0.5\textwidth}
        \centering
        \textbf{High Risk Scenario}\\
...
\begin{frame}{Expected Impact \& Conclusion}
    ...
    \small Questions? \hspace{1cm} [Insert GitHub Link]
\end{frame}
